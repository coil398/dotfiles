...
- **プロンプト**: 以下の情報をすべて渡す
  ...
  - `OBSERVATION_LOG_PATH=dotfiles .claude reference: memory/experimental_observations.md`（観測ログの記録先・git 管理外。実 run の観測データはここに記録し、`experimental.md` の Observation Log は触らない）
