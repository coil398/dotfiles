...
PIR² 系スキル（/pir2, /pir2async 共有）の feedback 照合ゲート。実装フェーズ（または pir2async チーム）を開始する前に、メインエージェント（スキル本体）が直前に追加した feedback との矛盾を照合する機械ゲート。
...
- 推奨アクション: <除外指示取り下げ / plan.md の該当箇所を増分更新 / 範囲拡大>
```
...
- 矛盾 feedback: <ファイルパス>
- 矛盾箇所: <実装プロンプト案の該当行>
- 推奨アクション: 除外指示を取り下げて plan.md の該当箇所を増分更新

このまま実装を開始しますか？（pir2async の場合: チームを起動しますか？）
- yes: 矛盾を承認して開始（理由をご教示ください）
- no: plan.md の該当箇所を増分更新してから開始（推奨）
```
