...
| # | ファイル | 入力系統 |
|---|---|---|
| 1 | `.cursor/skills/pir2/SKILL.md` | pwd 系 |
| 2 | `.cursor/skills/pir2async/SKILL.md` | pwd 系 |
| 3 | `.cursor/skills/debug/SKILL.md` | pwd 系 |
| 4 | `.cursor/skills/ir/SKILL.md` | pwd 系 |
| 5 | `.cursor/skills/reviewer/SKILL.md` | pwd 系 |
| 6 | `.cursor/skills/review-pr/SKILL.md` | pwd 系 |
| 7 | `.cursor/skills/writing-plan/SKILL.md` | pwd 系 |
| 8 | `.cursor/skills/refactor-advisor/SKILL.md` | pwd 系 |
| 9 | `.cursor/skills/retro/SKILL.md` | target_path 系 |
...
スクリプトパス: `.cursor/skills/pir2/references/verify-sanitized-cwd.sh`
