...
- `--codex`は先頭の明示フラグとしてだけ扱い、実装担当を`/codex`のrunner Taskへ差し替える。計画、scope、DAG、統合、受入は親に残し、Codex CLIのmodel・sandbox・証跡・待機は `${CURSOR_SKILLS_DIR}/codex/SKILL.md` のbridge契約に従う。
