...
- 独立したサブ問いがあり分離の利益がある場合だけ、Cursor の標準 Task または標準 read-only child を起動します。対象版、問い、確定事実、編集禁止、根拠をチャットで返すことと、必要な実行者用 Skill / reference の実体 path を渡し、子自身に資料を Read させます。
