...
from jev_stop_guard import policy  # noqa: E402
from jev_stop_guard.codex_hook import evaluate  # noqa: E402
from jev_stop_guard.config import Config, resolve_api_key  # noqa: E402
from jev_stop_guard.tests import rollout_fixture as fx  # noqa: E402
from jev_stop_guard.tests.eval_cases import ALLOW, CONTINUE, cases  # noqa: E402
...
def run_live(timeout_s: float) -> int:
    ...
    if not key:
        sys.stderr.write("TYPESAFE_API_KEY missing (env or ~/.zsh_secret). Skip live eval.\n")
        return 2
    cfg = Config(mode="observe", api_timeout_s=timeout_s, total_timeout_s=timeout_s + 2.0)
