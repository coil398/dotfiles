...
for s in cursor-pir2 cursor-pir2codex cursor-codex cursor-epic cursor-deepthink cursor-research cursor-ai-design-system cursor-ai-diary cursor-ai-ltm cursor-private-skill; do
