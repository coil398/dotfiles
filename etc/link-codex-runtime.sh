...
CODEX_ROOT_FILE_ALLOWLIST='config.toml private.config.toml AGENTS.md format.md pir-handoff.md user-feedback-protocol.md agent-delegation.md pir2-protocol.md dev-server.md subagent-permissions.md'
