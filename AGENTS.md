...
- Codex reads `.agents/skills` directly. `etc/sync-codex.sh` disables shared skills listed in `CODEX_EXCLUDED_SHARED_SKILLS` (currently `codex`) in the generated `.codex/config.toml`
