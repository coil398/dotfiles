...
PIR² 系スキル（/pir2, /pir2async 共有）の feedback 照合ゲート。実装フェーズ（または pir2async チーム）を開始する前に、main/primary agentが直前に追加した feedback との矛盾を照合する機械ゲート。
...
- 推奨アクション: <除外指示取り下げ / 既存planの増分更新 / 範囲拡大>
```
